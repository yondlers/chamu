        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('listings.update', ['listing', $listing])); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/slx/Code/chamu2/resources/views/listings/edit.blade.php ENDPATH**/ ?>