...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Create Lease Template')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('lease_templates.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/lease_templates/create.blade.php ENDPATH**/ ?>