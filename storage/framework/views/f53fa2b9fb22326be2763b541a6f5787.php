...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('header', null, []); ?> 
       <h2 class="font-semibold text-xl text-gray-800 leading-tight">
           <?php echo e(__('Manage Properties')); ?>
    ...
    <div class="py-8">
        ...
        <div class="mt-6 max-w-6xl mx-auto sm:px-5 lg:px-7">
            <div class="w-full text-center">
                <a href="<?php echo e(route('properties.create')); ?>" class="w-full block card rounded-lg border border-gray-300 bg-white shadow-md text-black">
                    Add Property +
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 py-4 max-w-6xl">
        <div id="tasksContainer1" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route('properties.show', ['property' => $property])); ?>" class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 border-l-4 border-l-yellow-500 animate-fade-in ${cardLayout} transform hover:scale-105">
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/properties/index.blade.php ENDPATH**/ ?>