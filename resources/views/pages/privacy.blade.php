    ...
    <main class="bg-[#f8fafc]">
        ...
        <section class="mx-auto grid max-w-4xl gap-5 px-5 py-10 lg:px-8">
            ...
            <article class="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-3 leading-7 text-neutral-600">Visitors can opt out of personalised advertising through <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" class="font-semibold text-[#01225E] underline">Google Ads Settings</a>. Visitors can also learn about opting out of some third-party vendors' use of cookies for personalised advertising at <a href="https://www.aboutads.info/" target="_blank" rel="noopener noreferrer" class="font-semibold text-[#01225E] underline">aboutads.info</a>.</p>
