        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="py-2 text-center">
                    <div class="mt-4 mb-4 max-w-6xl mx-auto sm:px-5 lg:px-7">
                        ...
                        <div class="w-full text-center">
                            <a href="<?php echo e(route('check_in_outs.index')); ?>"
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('check_in_outs.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>

                        <?php echo $checkInOutHtml; ?>
...
<?php endif; ?>
<?php /**PATH /Users/slx/Code/chamu2/resources/views/check_in_outs/create.blade.php ENDPATH**/ ?>