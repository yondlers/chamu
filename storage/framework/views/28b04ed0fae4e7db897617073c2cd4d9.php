    ...
    <div class="container mx-auto px-4 py-4 max-w-6xl">
        <div id="tasksContainer1" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($unit->unitType->name !== "Whole"): ?>


                    <a href="<?php echo e(route('units.edit', ['unit' => $unit])); ?>" class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 border-l-4 border-l-yellow-500 animate-fade-in ${cardLayout} transform hover:scale-105">
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/units/index.blade.php ENDPATH**/ ?>