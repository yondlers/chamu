        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('deposits.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>

                        <?php echo $depositHtml; ?>
...
<?php endif; ?>
<?php /**PATH /Users/slx/Code/chamu2/resources/views/deposits/create.blade.php ENDPATH**/ ?>