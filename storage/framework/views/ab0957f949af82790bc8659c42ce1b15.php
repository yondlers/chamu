        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('properties.update', ['property' => $property])); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-4 mb-4 max-w-6xl mx-auto sm:px-5 lg:px-7">
                        ...
                        <div class="w-full text-center">
                            <a href="<?php echo e(route('properties.index')); ?>"
                               ...
                               class="w-full font-bold block card rounded-lg border  text-white"
                            >
                                Delete
                            </a>
                        </div>
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/properties/edit.blade.php ENDPATH**/ ?>