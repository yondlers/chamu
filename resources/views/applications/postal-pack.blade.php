            ...
            <div class="no-print mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-col gap-2 sm:flex-row">
                    @if ($application->source_url)
                        <a href="{{ $application->source_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 rounded-xl border border-neutral-300 bg-white px-4 py-2.5 text-sm font-black text-neutral-800 hover:bg-neutral-50">
                    ...
                    <div class="rounded-xl border border-neutral-200 p-4">
                        ...
                        @if ($application->source_url)
                            <p class="mt-3 text-xs font-semibold text-neutral-500">
                                Source:
                                <a href="{{ $application->source_url }}" target="_blank" rel="noopener noreferrer" class="break-all text-[#01225E] underline">
