    ...
    <div class="py-8">
        ...
        <div class="mt-6 mb-6 max-w-6xl mx-auto sm:px-5 lg:px-7">
            <div class="w-full text-center">
                <a href="<?php echo e(route('leases.create')); ?>" class="w-full block card rounded-lg border border-gray-300 bg-white shadow-md text-black">
                    Register Lease
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 py-4 max-w-6xl">
        <div id="tasksContainer1" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php $__currentLoopData = $leases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lease): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route('leases.show', ['lease' => $lease])); ?>" class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 border-l-4 border-l-yellow-500 animate-fade-in ${cardLayout} transform hover:scale-105">
                    <div class="container px-4 mb-4 mt-4">

                        <div class="flex-grow min-w-0">
                            <h3 class="font-semibold text-gray-800 line-through truncate">
                                <?php echo e($lease->name); ?>
                        ...
                        <div class="flex-grow min-w-0">
                            <h3 class="font-semibold text-gray-800 line-through truncate">
                                R <?php echo e($lease->rent_amount); ?>
                        ...
                        <div class="text-xs text-gray-400 bg-gray-50 px-2 py-1 rounded">
                            Created <?php echo e($lease->created_at); ?>

                        </div>
                        <div class="text-xs text-gray-400 bg-gray-50 px-2 py-1 rounded">
                            Modified <?php echo e($lease->created_at); ?>
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/leases/index.blade.php ENDPATH**/ ?>