...
class CareerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Career source links are only for salary providers (PayScale).
        // University programme URLs belong on the qualification, not the career.
        $cleared = $upsert->clearNonSalarySources();
        $this->command?->info("Cleared {$cleared} non-salary career source URLs (kept PayScale only).");
