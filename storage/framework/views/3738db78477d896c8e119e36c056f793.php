        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <hr class="mt-2">
                    <form action="<?php echo e(route('tenants.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/tenants/create.blade.php ENDPATH**/ ?>