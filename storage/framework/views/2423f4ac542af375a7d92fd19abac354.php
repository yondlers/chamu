...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Edit Lease Template')); ?>

        </h2>
     <?php $__env->endSlot(); ?>

    <script src="<?php echo e(asset('js/tinymce/tinymce.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/tinymce/config.js')); ?>"></script>
    <script src="<?php echo e(asset('js/ajax_jquery/jquery.min.js')); ?>"></script>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <hr class="mt-2">
                    <form action="<?php echo e(route('lease_templates.update', ['lease_template' => $leaseTemplate])); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>

                        <?php echo $leaseTemplateForm; ?>
    ...
    <script>
        ...
        function copy(id)
        {
            ...
            // Toggle Tooltip here
            var button = $("#"+ id);
            button.tooltip({ title: "Copied!" }).tooltip("show");
            setTimeout(function () {
...
<?php /**PATH /Users/slx/Code/chamu2/resources/views/lease_templates/edit.blade.php ENDPATH**/ ?>