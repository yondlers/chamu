...
Route::middleware(['auth', 'super.admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/reports/users/{user}/course-match', [AdminReportController::class, 'course'])->name('reports.users.course');
    Route::get('/reports/users/{user}/bursaries', [AdminReportController::class, 'bursaries'])->name('reports.users.bursaries');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/reports/course-match', [ReportController::class, 'course'])->name('reports.course');
    Route::get('/reports/bursaries', [ReportController::class, 'bursaries'])->name('reports.bursaries');
    ...
    Route::get('/tutor/lookups/universities', [TutorApplicationController::class, 'searchUniversities'])->name('tutor.lookups.universities');
